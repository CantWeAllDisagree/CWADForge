...
import cantwe.alldisagree.CWADForge.api.fluid.AbstractMoltenMetalFluid;
...
import cantwe.alldisagree.CWADForge.api.item.FluidBucketItem;
...
public class ImplMoltenFluidRegistry implements ApiMoltenFluidRegistry {
    ...
    @Override
    public Collection<? extends RegistryEntry<?>> getCreateFluidEntries() {
    ...
    private static void reg(String fluidName)
    {
        ...
        Item FLUID_BUCKET = Registry.register(Registry.ITEM, id,
                new FluidBucketItem(STILL_FLUID, new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1), fluidName));
