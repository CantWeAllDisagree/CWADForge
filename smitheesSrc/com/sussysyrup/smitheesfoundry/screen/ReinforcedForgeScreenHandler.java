...
public class ReinforcedForgeScreenHandler extends ScreenHandler {

    private final Inventory inventory;

    private PlayerEntity player;

    public ReinforcedForgeScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(6));
    }

    public ReinforcedForgeScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory)
    {
        super(ModScreenHandlerRegistry.REINFORCED_FORGE_SCREEN_HANDLER, syncId);
        ReinforcedForgeScreenHandler.checkSize(inventory, 6);
