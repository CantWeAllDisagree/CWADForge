...
public class FluidRegistry {
    ...
    private static void normalFluids()
    {
        ...
        CRUDE_RESONATOR_BUCKET = Registry.register(Registry.ITEM, new Identifier(Main.MODID, "crude_resonator_bucket"),
                new BucketItem(STILL_CRUDE_RESONATOR, new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1).group(ItemGroups.ITEM_GROUP)));
        ...
        RESONATOR_BUCKET = Registry.register(Registry.ITEM, new Identifier(Main.MODID, "resonator_bucket"),
                new BucketItem(STILL_RESONATOR, new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1).group(ItemGroups.ITEM_GROUP)));
